...
| 1 | `OPEN` | Дані BorgWarner за НОВИМИ ідентифікаторами `BV39A-0012` / `NE 1003/1756-00002` | компресорна карта / технічні межі; старий пошук за `54399880072` не мав сенсу — цього номера на табличці немає |
...
ідентифікацію.** Турбіна тепер `MEASURED` (BorgWarner BV39A-0012 /
