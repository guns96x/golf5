...
| | [research-changelog.md](research-changelog.md) | Ingestion changelog and history |
...
| **Air Path & Boost Control** | [boost-control.md](boost-control.md) | Target calculation (`PCR_pBDesBas_MAP`), atmospheric/temp derating |
| | [vnt-n75-control.md](vnt-n75-control.md) | N75 pre-control (`PCR_rBPCtlBas_MAP`), vane mechanics, EGR impact |
| **Fueling & Combustion** | [fueling-and-limiters.md](fueling-and-limiters.md) | Limiter cascade (Driver Wish, Torque Limit, Smoke Limit) |
| | [smoke-limiter.md](smoke-limiter.md) | MAP-based (`FlMng_qPresSmoke_MAP`) vs MAF-based limitation |
| | [injection-duration.md](injection-duration.md) | PD unit injector duration maps (`InjCrv_phiDur_MAP`) |
| | [injection-timing.md](injection-timing.md) | Start of Injection (`InjCrv_phiMI1Des_MAP`) & cylinder pressure |
| | [hot-start.md](hot-start.md) | Cranking fuel map (`EngM_qStart_MAP`) & warm start hesitation fix |
| | [thermal-protection.md](thermal-protection.md) | Modeled EGT, thermal derating & component protection |
| **Calibration & Lineage** | [a2l-map-index.md](a2l-map-index.md) | Catalog of verified active maps with addresses in SW `1037391847` |
| | [firmware-lineage.md](firmware-lineage.md) | Factory HEX reference vs Stage 1 refined CS_OK vs DPF/EGR OFF |
| **Telemetry & Investigation** | [log-index.md](log-index.md) | Inventory of VCDS WOT and Turbo Fast road test logs |
| | [experiment-results.md](experiment-results.md) | Analysis of 2310–2330 mbar transient boost overshoot |
| | [conflicting-evidence.md](conflicting-evidence.md) | Resolution of conflicting claims (N75 polarity, smoke limiter) |
| | [open-questions.md](open-questions.md) | 15 prioritized project questions & competing boost hypotheses |
| | [recommended-tests.md](recommended-tests.md) | Standardized VCDS logging protocols (Group 011 high-rate run) |
